    ...
    <div className="privacy-page-wrapper">
      ...
      <div className="page">
        ...
        <section className="privacy-section">
          ...
          <p>
            HealBot(이하 "회사")은 다음의 목적을 위하여 개인정보를 처리합니다.
            처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며,
            이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
          </p>
          <ol>
            <li><strong>회원 가입 및 관리</strong>: 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지</li>
            <li><strong>서비스 제공</strong>: 맞춤형 의료정보 제공, 증상 검색 서비스, 병원 정보 제공, 커뮤니티 서비스 제공</li>
          ...
          <ol>
            ...
            <li>각각의 개인정보 처리 및 보유 기간은 다음과 같습니다:
              <ul>
                ...
                <li><strong>소비자 불만 또는 분쟁처리 기록</strong>: 3년</li>
              </ul>
            </li>
          </ol>
        </section>
        ...
        <section className="privacy-section">
          ...
          <ol>
            ...
            <li>개인정보 파기의 절차 및 방법은 다음과 같습니다:
              <ul>
                <li><strong>파기절차</strong>: 파기 사유가 발생한 개인정보를 선정하고, 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.</li>
        ...
        <section className="privacy-section">
          ...
          <ol>
            ...
            <li>쿠키는 웹사이트를 운영하는데 이용되는 서버가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.</li>
            <li>쿠키 설정 거부 방법: 웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다.
              <ul>
