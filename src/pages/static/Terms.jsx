    ...
    <div className="terms-page-wrapper">
      ...
      <div className="page">
        ...
        <section className="terms-section">
          <h2>제1조 (목적)</h2>
          <p>
            본 약관은 HealBot(이하 "회사")이 제공하는 의료 정보 서비스(이하 "서비스")의 이용과 관련하여
        ...
        <section className="terms-section">
          ...
          <ol>
            ...
            <li>"비밀번호"란 회원이 부여받은 아이디와 일치되는 회원임을 확인하고 비밀보호를 위해 회원 자신이 설정한 문자 또는 숫자의 조합을 의미합니다.</li>
          </ol>
        </section>
        ...
        <section className="terms-section">
          ...
          <ol>
            ...
            <li>회사는 합리적인 사유가 발생할 경우 관련 법령에 위배되지 않는 범위 안에서 본 약관을 변경할 수 있습니다.</li>
            <li>회사가 약관을 변경할 경우에는 적용일자 및 변경사유를 명시하여 현행약관과 함께 서비스 초기화면에 그 적용일자 7일 이전부터 공지합니다.</li>
          </ol>
        </section>
        ...
        <section className="terms-section">
          <h2>제4조 (이용계약의 체결)</h2>
          <ol>
            <li>이용계약은 회원이 되고자 하는 자(이하 "가입신청자")가 본 약관의 내용에 동의를 한 다음 회원가입신청을 하고 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.</li>
        ...
        <section className="terms-section">
          <h2>제8조 (의료 정보의 한계)</h2>
          <ol>
            <li>본 서비스에서 제공하는 모든 정보는 일반적인 의료 정보 제공을 목적으로 하며, 의사의 진단이나 치료를 대체할 수 없습니다.</li>
            <li>회원은 본 서비스의 정보를 참고자료로만 활용해야 하며, 정확한 진단 및 치료는 반드시 의료 전문가와 상담해야 합니다.</li>
            <li>회사는 서비스에서 제공하는 정보의 정확성, 완전성, 신뢰성에 대해 최선을 다하나, 이에 대한 법적 책임을 지지 않습니다.</li>
          </ol>
        </section>
        ...
        <div className="terms-footer">
          ...
          <p>이메일: support@healbot.com | 전화: 1588-0000</p>
        </div>
      </div>
      <Footer />
      <ScrollToTop />
