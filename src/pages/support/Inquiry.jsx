      ...
      <div className="page">
        ...
        <div className="inquiry-container">
          <div className="inquiry-info-box">
            ...
            <ul>
              <li>
                <a href="/faq">자주 묻는 질문</a>에서 먼저 확인해 보세요
              </li>
          ...
          <form className="inquiry-form" onSubmit={handleSubmit}>
            ...
            <div className="inquiry-form-group">
              <label>
                답변 받으실 이메일 <span className="required">*</span>
              </label>
              <input
                type="email"
                name="email"
            ...
            <div className="inquiry-form-group">
              ...
              <div className="file-upload-wrapper">
                <input type="file" id="file-upload" onChange={handleFileChange} accept="image/*,.pdf,.doc,.docx" />
            ...
            <div className="inquiry-privacy-check">
              ...
              <button type="button" className="privacy-detail-btn">
                상세보기
              </button>
            </div>
