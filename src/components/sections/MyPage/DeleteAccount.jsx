    ...
    <div className="review-page-wrapper">
      ...
      <section className="da-wrap">
        <form className="da-box" onSubmit={handleSubmit}>
          <h2 className="da-title">회원 탈퇴를 신청하기 전, 다음 내용을 꼭 확인해 주세요.</h2>

          <ul className="da-list">
            <li>고객 정보 및 개인형 서비스 이용 기록은 개인정보 처리 방침 기준에 따라 삭제됩니다.</li>
            <li>보유하고 계신 적립금은 최근 정보에 등록된 계좌로 3~7 영업일 이내에 자동 입금 처리됩니다.</li>
            <li>회원 탈퇴 후에는 동일 아이디 재사용이 제한될 수 있으며, 서비스 이용이 불가능합니다.</li>
          </ul>
          ...
          <div className="da-btn-row">
            ...
            <button type="button" className="da-btn da-btn-secondary" onClick={handleCancel}>
              취소
            </button>
          </div>
        </form>
