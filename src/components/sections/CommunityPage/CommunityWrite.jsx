        ...
        <div className="community-write-container">
          <section className="community-write-header">
            ...
            <p className="community-write-subtitle">
              ...
              <br />
              서비스의 투명성을 유지하고 기록의 일관성을 위해 게시물 수정은 지원되지 않습니다. 게시물을 삭제하신 후 다시
              작성해 주시기 바랍니다.
            </p>
          </section>
          ...
          <article className="community-write-card">
              ...
              <div className="cw-category-group">
                {CATEGORY_OPTIONS.map((opt) => (
                  <button
                    key={opt.key}
                    type="button"
                    className={`cw-category-btn ${category === opt.key ? "active" : ""}`}
            ...
            <div className="cw-row">
              ...
              />
              <div className="cw-help-text">의료기관·개인 실명 언급 및 비방성 내용은 삭제될 수 있습니다.</div>
            </div>

            <div className="cw-footer">
              <button type="button" className="cw-btn cw-btn-secondary" onClick={handleCancel} disabled={isSubmitting}>
                취소
              </button>
              <button type="button" className="cw-btn cw-btn-primary" onClick={handleSubmit} disabled={isSubmitting}>
