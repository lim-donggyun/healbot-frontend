...
return (
    ...
    <main className="community-detail-main">
        ...
        <article className="community-detail-card">
            ...
            <p className="cd-comment-guide">
                의료기관/개인을 비방하거나 개인정보가 포함된 글은 제재될 수 있습니다.
            </p>
            ...
            <form className="cd-comment-form" onSubmit={handleCommentSubmit}>
                ...
                <span className="cd-comment-hint">
                    로그인한 계정으로 등록됩니다.
                </span>
                <button
                    type="submit"
