...
const SocialLoginModal = ({ isOpen, onClose, loginType }) => {
  ...
  useEffect(() => {
    ...
    if (loginType === "kakao") {
      ...
      const popup = window.open(kakaoAuthUrl, "kakao_login", `width=${width},height=${height},left=${left},top=${top}`);
      ...
      const popup = window.open(naverAuthUrl, "naver_login", `width=${width},height=${height},left=${left},top=${top}`);
